...
export default function Results(props) {
    ...
    if (props.weatherData.cod !== "404" && props.weatherData) {
        return (<><div className="results" >
            <h1>{data.main.temp.toFixed(1)}°C <i id="temp-icon" className={`ri-${temp_class}-line`}></i></h1>
            <h2>{props.langVals.feelsLike.toString()}{data.main.feels_like.toFixed(1)}°C</h2>
